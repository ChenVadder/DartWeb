...
let modulePaths = {
 ...
 "web/removeElements": "removeElements.sound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'removeElements.digests',
...
define("removeElements.dart.bootstrap", ["web/removeElements", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__removeElements || app.removeElements).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "removeElements.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("removeElements.dart.bootstrap", {
    "removeElements.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
