...
let modulePaths = {
 ...
 "web/loadRemoteFile": "loadRemoteFile.sound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'loadRemoteFile.digests',
...
define("loadRemoteFile.dart.bootstrap", ["web/loadRemoteFile", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__loadRemoteFile || app.loadRemoteFile).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "loadRemoteFile.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("loadRemoteFile.dart.bootstrap", {
    "loadRemoteFile.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
