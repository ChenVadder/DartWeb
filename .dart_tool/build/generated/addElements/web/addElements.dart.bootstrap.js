...
let modulePaths = {
 ...
 "web/addElements": "addElements.sound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'addElements.digests',
...
define("addElements.dart.bootstrap", ["web/addElements", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__addElements || app.addElements).main();
  var bootstrap = {
  ...
  dart_sdk.dart.trackLibraries("addElements.dart.bootstrap", {
    "addElements.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
