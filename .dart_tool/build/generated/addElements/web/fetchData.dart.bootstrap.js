...
let modulePaths = {
 ...
 "web/fetchData": "fetchData.sound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'fetchData.digests',
...
define("fetchData.dart.bootstrap", ["web/fetchData", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__fetchData || app.fetchData).main();
  var bootstrap = {
  ...
  dart_sdk.dart.trackLibraries("fetchData.dart.bootstrap", {
    "fetchData.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
